...
public class ActivityBuscarActualizar extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_buscar_actualizar);
        ...
        btnBuscar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                RepositoryApiRest dao = new RepositoryApiRest(ActivityBuscarActualizar.this);
                dao.getUsuario(editTextUserId.getText().toString(), ActivityBuscarActualizar.this, Request.Method.GET);
            }
        });
        ...
        btnActualizar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                params.put("nombres", editTextNombres.getText().toString());
                params.put("apellidos", editTextApellidos.getText().toString());
                params.put("usuario", editTextUsuario.getText().toString());
                params.put("pass", editTextPass.getText().toString());

                Log.i("se envia: ", params.toString());
                RepositoryApiRest dao = new RepositoryApiRest(ActivityBuscarActualizar.this);
                dao.crudUsuario(params, ActivityBuscarActualizar.this, Request.Method.PUT);
            }
        });
    }
